...
export default function PostBriefModal({ task, open, onClose }: PostBriefModalProps) {
  ...
  return (
    ...
    >
      <div
        className="bg-surface border border-border-color/60 rounded-t-2xl sm:rounded-2xl shadow-card-hover w-full sm:max-w-[1100px] max-h-[95dvh] sm:max-h-[90dvh] relative animate-scaleIn overflow-hidden flex flex-col sm:mx-4"
